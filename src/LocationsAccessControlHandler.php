 ...
 *
 * @see \Drupal\custom_migration_mongo\Entity\Locations.
 */
class LocationsAccessControlHandler extends EntityAccessControlHandler {

  /**
   * {@inheritdoc}
   */
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account) {
    /** @var \Drupal\custom_migration_mongo\Entity\LocationsInterface $entity */
